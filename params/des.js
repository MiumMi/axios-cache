...
export class des{
  ...
  strEnc(data, firstKey, secondKey, thirdKey) {
    ...
    if (leng < 4) {
      var index;
      var encBt = this.strToBt(data);
      if (firstLength > 0) {
        for (index = 0; index < firstLength; index++) {
          encBt = this.enc(encBt, firstKeyBt[index]);
        }
        if (secondLength > 0) {
          for (index = 0; index < secondLength; index++) {
            encBt = this.enc(encBt, secondKeyBt[index]);
          }
          if (thirdLength > 0) {
            for (index = 0; index < thirdLength; index++) {
              encBt = this.enc(encBt, thirdKeyBt[index]);
            }
          }
        }
      }
      encData = this.bt64ToHex(encBt);
    } else {
      ...
      for (i = 0; i < iterator; i++) {
        ...
        var encBt = this.strToBt(tempData);
        var index;
        if (firstLength > 0) {
          for (index = 0; index < firstLength; index++) {
            encBt = this.enc(encBt, firstKeyBt[index]);
      ...
      if (remainder > 0) {
        ...
        var encBt = this.strToBt(remainderData);
        var index;
        if (firstLength > 0) {
          for (index = 0; index < firstLength; index++) {
            encBt = this.enc(encBt, firstKeyBt[index]);
